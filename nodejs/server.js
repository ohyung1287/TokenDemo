...
//envSetup
let web3;
let DRM_address = '0xf7775aeb48dc8473ce3dcff43a657d213d6981d1';
let DRM_owner = '0x5efDD3CAb3c3Ea3D1725B8EaF340Cc8d5a9B7547';
let DRM_ownerKey='45F93E7A6CF774228519708AA97529A9CE2A663E26E67F183FE49BB9C90D468D';

var infuraLink = 'https://rinkeby.infura.io/v3/7a19de34892e4625b8464eac960146b7';
...
app.post("/artistRegister/",async (req,res)=>{
    try{
        ...
        .artistRegister(address,name).encodeABI();
...
app.post("/purchaseInPeriod/",async (req,res)=>{
    try{
        ...
        var transfer = await DRM.methods.
        purchaseInPeriod(dateStart, dateEnd, tokenId).encodeABI();
        await sendTxn(transfer);
        res.sendStatus(200);
    }catch(err){
        console.log(err);
...
async function getGasPrice(){
    var price;
    try{
        var fetchJson = await fetch('https://www.etherchain.org/api/gasPriceOracle');
